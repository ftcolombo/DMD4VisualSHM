...
[X1, X2, ~] = time_embedding(X, na, 0:1/fs:T);
...
for k = kk
    ...
    sr(1:length(s_dmd), i) = s_dmd;
    
    clear Ur Sr Vr Vs Atilde D lambda s_dmd

end

% save('../Data/stabilizationdata_00_00_00_run1I.mat','sr','kk','nr')
